 ...
 *
 * Lets the user freely pair an embedding (vision) model with an LLM by catalog
 * id. The resulting handle has models[0] = embedding producer (vision) and
 * models[1] = consumer (LLM); the multimodal run path drives the pair through
