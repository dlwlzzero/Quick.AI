...
__attribute__((constructor)) static void register_custom_models() {
  ...
  static const ModelDescriptor d = {
    "gauss-3.6-qnn",   "gauss-3.6",
    "Gauss 3.6 (QNN)", QDA_RUNTIME_NATIVE,
    (1u << 2),         QDA_CAP_STREAMING | QDA_CAP_MESSAGES_API,
    "gauss-3.6-qnn",   "Gauss_3_6_QNN"};
...
// ---------------------------------------------------------------------------
// Self-registration: Gauss_3_6_QNN callbacks
// ---------------------------------------------------------------------------
...
struct Gauss36Registrar {
  Gauss36Registrar() {
    ModelCallbackRegistry::instance().register_for("Gauss_3_6_QNN", {
...
static Gauss36Registrar g_gauss36_registrar;
