...
#ifndef __GAUSS_3_8_VIT_QNN_H__
#define __GAUSS_3_8_VIT_QNN_H__
...
/**
 * @brief Gauss3_8_VIT_QNN class
 * @note  This is the main class you register with the Factory.
 *
 */
class Gauss3_8_VIT_QNN : public Quick_Dot_AI_QNN {

public:
  static constexpr const char *architectures = "Gauss_3_8_Visual_VIT_QNN";

  Gauss3_8_VIT_QNN(json &cfg, json &generation_cfg, json &nntr_cfg)
      : Quick_Dot_AI_QNN(cfg, generation_cfg, nntr_cfg) {
    setupParameters(cfg, generation_cfg, nntr_cfg);
    uses_embedding = false;
  }

  virtual ~Gauss3_8_VIT_QNN() = default;
